    ...
    <div className="flex flex-col h-screen bg-[#F0F2F5] overflow-hidden">
      ...
      <div className="flex flex-grow overflow-hidden relative">
        ...
        <div className="flex-grow flex flex-col items-center overflow-y-auto pt-12 pb-24 relative bg-[#F0F2F5] custom-scrollbar">
          ...
          >
            {/* Page 1 */}
            <div className="resume-shadow bg-white w-[850px] min-h-[1100px] p-0 relative group shrink-0">
               <ResumePage page={1} data={data} onChange={onChange} />
            </div>

            {/* Page 2 */}
            <div className="resume-shadow bg-white w-[850px] min-h-[1100px] p-0 relative group shrink-0">
               <ResumePage page={2} data={data} onChange={onChange} />
            </div>
          </div>
