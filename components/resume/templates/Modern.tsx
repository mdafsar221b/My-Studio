...
const Modern: React.FC<TemplateProps> = ({ data, layout, design, isReadOnly, onUpdate, renderSection }) => {
    ...
    return (
        <div className="flex flex-grow w-full">
            ...
            >
                <div className="mb-14">
                    {/* Modern has a distinct header style (often simple left aligned) */}
                    <h1
            ...
            >
                ...
                {/* Footer / Contact Info - Modern Style */}
