...
const DoubleColumn: React.FC<TemplateProps> = ({ data, pageContent, design, isReadOnly, isFirstPage, onUpdate, renderSection }) => {
    ...
    return (
        <div className="flex flex-grow w-full">
            ...
            >
                ...
                {/* Render Left Column Sections from Paginated Content */}
