  ...
  const renderTemplateCard = (t: typeof TEMPLATES[0], isModal = false) => (
    ...
    >
      <div className={`aspect-[3/4] border-2 rounded-xl shadow-sm group-hover:shadow-md transition-all relative overflow-hidden bg-white 
        ...
        {activeTemplate === t.id && (
          <div className="absolute inset-0 bg-teal-500/20 flex items-center justify-center backdrop-blur-[1px] z-20">
            <div className="bg-teal-500 text-white rounded-full p-2 shadow-lg animate-in zoom-in-50 duration-200">
